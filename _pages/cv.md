...
Awards
======
* **2024 ICPC Hangzhou Regional Contest**: Gold Medal $\color{orange}{\text{#} 15}$
* **2024 CCPC Zhengzhou Regional Contest**: Gold Medal $\color{orange}{\text{#} 22}$
* **2024 ICPC Shenyang Regional Contest**: Silver Medal $\color{gray}{\text{#} 64}$
* **2024 ICPC Asia East Continent Final Contest**: Silver Medal $\color{gray}{\text{#} 55}$
